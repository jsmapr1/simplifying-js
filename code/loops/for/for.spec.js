...
describe('for loop on Map', () => {
  it('should return false on negative result', () => {
    ...
    expect(checkConflicts(firms, soundscapeUnavailable)).toEqual('Soundscape is not available');
  });

  it('should return false on negative result for full with find', () => {
    const soundscapeUnavailable = id => id !== 23;
    expect(findConflicts(firms, soundscapeUnavailable)).toEqual('Soundscape is not available');
  });

  it('should return false on negative result for full', () => {
    const soundscapeUnavailable = id => id !== 23;
    expect(checkConflictsFull(firms, soundscapeUnavailable)).toEqual('Soundscape is not available');
  });

  it('should return false on negative result for traditional', () => {
    const soundscapeUnavailable = id => id !== 23;
    expect(checkConflictsTrad(firms, soundscapeUnavailable)).toEqual('Soundscape is not available');
  });
...
describe('for loop on objects', () => {
  it('should return false on negative result for traditional', () => {
    const soundscapeUnavailable = id => id !== 23;
    expect(checkIn(firmsIn, soundscapeUnavailable)).toEqual('Soundscape is not available');
  });
